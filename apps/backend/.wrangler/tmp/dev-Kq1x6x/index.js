...
// ../../packages/openapi/src/schemas/common.ts
var IdSchema = external_exports.string().uuid();
var TimestampSchema = external_exports.object({
...
var HistoryEntrySchema = external_exports.object({
  ...
  changes: external_exports.record(external_exports.unknown()),
  userId: external_exports.string().optional(),
  userName: external_exports.string().optional(),
  timestamp: external_exports.string().datetime()
});

// ../../packages/openapi/src/schemas/kpi.ts
var PhaseDataSchema = external_exports.object({
  phaseName: external_exports.string(),
  targetValue: external_exports.number().optional(),
  actualValue: external_exports.number().optional()
});
var KpiSchema = external_exports.object({
  ...
  phaseData: external_exports.array(PhaseDataSchema).optional(),
  comments: external_exports.array(CommentSchema).optional()
}).merge(TimestampSchema).merge(AuditSchema);
var CreateKpiSchema = KpiSchema.omit({
  id: true,
  createdAt: true,
  updatedAt: true,
  comments: true
});
var UpdateKpiSchema = CreateKpiSchema.partial();

// ../../packages/openapi/src/schemas/kpi-snapshot.ts
var KpiSnapshotSchema = external_exports.object({
  id: IdSchema,
  kpiId: external_exports.string(),
  // KPIのID
  snapshotDate: external_exports.string(),
  // ISO 8601 date string (日付のみ)
  phaseData: external_exports.array(PhaseDataSchema).optional(),
  // その日の暫定データ
  comments: external_exports.string().optional()
  // その日のコメント
}).merge(TimestampSchema).merge(AuditSchema);
var CreateKpiSnapshotSchema = KpiSnapshotSchema.omit({
  id: true,
  createdAt: true,
  updatedAt: true
});
var UpdateKpiSnapshotSchema = CreateKpiSnapshotSchema.partial();

// ../../packages/openapi/src/schemas/initiative.ts
var InitiativeStatusSchema = external_exports.enum(["planned", "in_progress", "completed", "on_hold"]);
var InitiativeSchema = external_exports.object({
  id: IdSchema,
  timingStart: external_exports.string(),
  // ISO 8601 date string
  timingEnd: external_exports.string().optional(),
  // ISO 8601 date string
  schedule: external_exports.string().optional(),
  milestone: external_exports.string(),
  mainOwner: external_exports.string(),
  outputAndGoal: external_exports.string(),
  status: InitiativeStatusSchema.optional(),
  notes: external_exports.string().optional(),
  comments: external_exports.array(CommentSchema).optional()
}).merge(TimestampSchema).merge(AuditSchema);
var CreateInitiativeSchema = InitiativeSchema.omit({
  id: true,
  createdAt: true,
  updatedAt: true,
  comments: true
});
var UpdateInitiativeSchema = CreateInitiativeSchema.partial();

// ../../packages/openapi/src/schemas/company-analysis.ts
var CompetitorSchema = external_exports.object({
  id: IdSchema,
  no: external_exports.number(),
  companyName: external_exports.string(),
  sales: external_exports.string().optional(),
  targetMarketSegment: external_exports.string().optional(),
  competitiveAdvantagePoint: external_exports.string().optional()
});
var CompanyPositionSchema = external_exports.object({
  id: IdSchema,
  description: external_exports.string()
});
var CompetitorStrategySchema = external_exports.object({
  id: IdSchema,
  companyName: external_exports.string(),
  pricePosition: external_exports.enum(["low", "medium", "high"]),
  valuePosition: external_exports.enum(["low", "medium", "high"])
});
var IndustryPlayerCharacteristicSchema = external_exports.object({
  id: IdSchema,
  characteristic: external_exports.string()
});
var ExternalInternalAnalysisSchema = external_exports.object({
  id: IdSchema,
  strengths: external_exports.array(external_exports.string()),
  weaknesses: external_exports.array(external_exports.string()),
  opportunities: external_exports.array(external_exports.string()),
  threats: external_exports.array(external_exports.string()),
  targetPosition: external_exports.string().optional()
});
var MarketResearchSchema = external_exports.object({
  id: IdSchema,
  marketMacro: external_exports.string().optional(),
  marketSegment: external_exports.string().optional(),
  customerCharacteristics: external_exports.string().optional()
});
var CompetitiveAdvantageSchema = external_exports.object({
  id: IdSchema,
  ...
  technology: external_exports.string().optional(),
  talent: external_exports.string().optional(),
  values: external_exports.string().optional(),
  competitiveAdvantageSource: external_exports.string().optional()
});
var FutureMarketOutlookSchema = external_exports.object({
  id: IdSchema,
  marketChanges: external_exports.string().optional(),
...
var UpdateCompanyAnalysisSchema = CreateCompanyAnalysisSchema.partial();

// ../../packages/openapi/src/schemas/job-posting.ts
var JobPostingStatusSchema = external_exports.enum(["draft", "under_review", "published", "closed"]);
var JobRevisionSchema = external_exports.object({
  id: IdSchema,
...
var JobPostingSchema = external_exports.object({
  ...
  requiredQualifications: external_exports.string().optional(),
  preferredQualifications: external_exports.string().optional(),
  salary: external_exports.string().optional(),
  workLocation: external_exports.string().optional(),
  employmentType: external_exports.string().optional(),
  status: JobPostingStatusSchema,
  revisions: external_exports.array(JobRevisionSchema).optional(),
  notes: external_exports.string().optional(),
  comments: external_exports.array(CommentSchema).optional()
}).merge(TimestampSchema).merge(AuditSchema);
var CreateJobPostingSchema = JobPostingSchema.omit({
  id: true,
  createdAt: true,
  updatedAt: true,
  revisions: true,
...
var UpdateJobPostingSchema = CreateJobPostingSchema.partial();

// ../../packages/openapi/src/schemas/job-role.ts
var TargetTypeSchema = external_exports.enum(["internal", "agt", "both"]);
var JobRoleSchema = external_exports.object({
  id: IdSchema,
  jobType: external_exports.string(),
  grade: external_exports.string(),
  mission: external_exports.string().optional(),
  specificTasks: external_exports.string().optional(),
  targetType: TargetTypeSchema.optional(),
  notes: external_exports.string().optional(),
  comments: external_exports.array(CommentSchema).optional()
}).merge(TimestampSchema).merge(AuditSchema);
var CreateJobRoleSchema = JobRoleSchema.omit({
  id: true,
  createdAt: true,
  updatedAt: true,
  comments: true
});
var UpdateJobRoleSchema = CreateJobRoleSchema.partial();

// ../../packages/openapi/src/schemas/competitor-job.ts
var CompetitorJobSchema = external_exports.object({
  id: IdSchema,
  companyName: external_exports.string(),
  position: external_exports.string(),
  jobUrl: external_exports.string().url().optional(),
  highlightPoints: external_exports.string().optional(),
  salary: external_exports.string().optional(),
  jobDescription: external_exports.string().optional(),
...
var CreateCompetitorJobSchema = CompetitorJobSchema.omit({
  id: true,
  createdAt: true,
  updatedAt: true,
  comments: true
...
var CreateSelectionProcessSchema = SelectionProcessSchema.omit({
  id: true,
  createdAt: true,
  updatedAt: true,
  comments: true
});
var UpdateSelectionProcessSchema = CreateSelectionProcessSchema.partial();

// ../../packages/openapi/src/schemas/recruitment-channel.ts
var RecruitmentChannelSchema = external_exports.object({
  id: IdSchema,
  channelName: external_exports.string(),
  characteristics: external_exports.string().optional(),
  targetJobTypes: external_exports.array(external_exports.string()).optional(),
  cost: external_exports.string().optional(),
  effectiveness: external_exports.string().optional(),
  notes: external_exports.string().optional(),
  comments: external_exports.array(CommentSchema).optional()
}).merge(TimestampSchema).merge(AuditSchema);
var CreateRecruitmentChannelSchema = RecruitmentChannelSchema.omit({
  id: true,
  createdAt: true,
  updatedAt: true,
  comments: true
});
var UpdateRecruitmentChannelSchema = CreateRecruitmentChannelSchema.partial();

// ../../packages/openapi/src/schemas/faq.ts
...
var CreateFaqSchema = FaqSchema.omit({
  id: true,
  createdAt: true,
  updatedAt: true,
  comments: true
...
__name(toDbRecord, "toDbRecord");
function fromDbRecord(record, jsonFields = []) {
  const result = {};
...
function createD1Service(db, entityType) {
  ...
  return {
    async getAll() {
      ...
      return (result.results || []).map((row) => fromDbRecord(row, jsonFields));
    },
    async getById(id) {
      const result = await db.prepare(`SELECT * FROM ${tableName} WHERE id = ?`).bind(id).first();
      if (!result)
        return null;
      return fromDbRecord(result, jsonFields);
    },
    async create(data) {
      ...
      const dbRecord = toDbRecord(entity);
      const columns = Object.keys(dbRecord);
      const placeholders = columns.map(() => "?").join(", ");
      const values = Object.values(dbRecord);
      await db.prepare(`INSERT INTO ${tableName} (${columns.join(", ")}) VALUES (${placeholders})`).bind(...values).run();
    ...
    async update(id, data) {
      ...
      const dbRecord = toDbRecord(updated);
      const setClause = Object.keys(dbRecord).filter((k) => k !== "id").map((k) => `${k} = ?`).join(", ");
      const values = Object.entries(dbRecord).filter(([k]) => k !== "id").map(([, v]) => v);
      await db.prepare(`UPDATE ${tableName} SET ${setClause} WHERE id = ?`).bind(...values, id).run();
      await addHistoryEntry(db, {
        entityId: id,
        entityType,
        action: "update",
...
__name(createD1Service, "createD1Service");
async function addHistoryEntry(db, entry) {
  const id = crypto.randomUUID();
...
__name(addHistoryEntry, "addHistoryEntry");
async function getHistory(db, entityId, entityType) {
...
var BaseService = class {
  db;
  entityType;
  constructor(db, entityType) {
    this.db = db;
    this.entityType = entityType;
  }
  getRepository() {
    return createD1Service(this.db, this.entityType);
  }
  async getAll() {
...
var KpiService = class extends BaseService {
  constructor(db) {
    super(db, "kpi");
  }
  // 将来的にビジネスロジックを追加可能
...
__name(KpiService, "KpiService");

// src/routes/base.routes.ts
function createCrudRoutes(app2, basePath, serviceFactory, createSchema, updateSchema, entityName) {
  app2.get(basePath, async (c) => {
    const service = serviceFactory(c.env.DB);
    const items = await service.getAll();
    return c.json(items);
  });
  app2.get(`${basePath}/:id`, async (c) => {
...
__name(createCrudRoutes, "createCrudRoutes");
...
__name(registerKpiRoutes, "registerKpiRoutes");

// src/services/kpi-snapshot.service.ts
var KpiSnapshotService = class {
  db;
  constructor(db) {
    this.db = db;
  }
  getRepository() {
    return createD1Service(this.db, "kpiSnapshot");
  }
  async getAll() {
    const repository = this.getRepository();
    return await repository.getAll();
  ...
  async getByKpiId(kpiId) {
    const repository = this.getRepository();
    const result = await this.db.prepare(`SELECT * FROM kpi_snapshots WHERE kpi_id = ? ORDER BY snapshot_date DESC`).bind(kpiId).all();
    ...
    return (result.results || []).map((row) => {
      ...
      for (const [key, value] of Object.entries(record)) {
        ...
        if (jsonFields.includes(camelKey) && typeof value === "string") {
          try {
            result2[camelKey] = JSON.parse(value);
          } catch {
  ...
  async getByKpiIdAndDate(kpiId, snapshotDate) {
    const result = await this.db.prepare(`SELECT * FROM kpi_snapshots WHERE kpi_id = ? AND snapshot_date = ?`).bind(kpiId, snapshotDate).first();
    if (!result)
      return null;
    const record = result;
    const jsonFields = ["phaseData"];
...
__name(KpiSnapshotService, "KpiSnapshotService");

// src/routes/kpi-snapshot.routes.ts
function registerKpiSnapshotRoutes(app2) {
  ...
  app2.get(`${basePath}/kpi/:kpiId`, async (c) => {
...
__name(registerKpiSnapshotRoutes, "registerKpiSnapshotRoutes");

// src/services/initiative.service.ts
var InitiativeService = class extends BaseService {
  constructor(db) {
    super(db, "initiative");
  }
};
__name(InitiativeService, "InitiativeService");

// src/routes/initiative.routes.ts
...
__name(registerInitiativeRoutes, "registerInitiativeRoutes");

// src/services/company-analysis.service.ts
var CompanyAnalysisService = class extends BaseService {
  constructor(db) {
    super(db, "companyAnalysis");
  }
};
__name(CompanyAnalysisService, "CompanyAnalysisService");

// src/routes/company-analysis.routes.ts
function registerCompanyAnalysisRoutes(app2) {
  createCrudRoutes(
    app2,
...
__name(registerCompanyAnalysisRoutes, "registerCompanyAnalysisRoutes");

// src/services/job-posting.service.ts
var JobPostingService = class extends BaseService {
  constructor(db) {
    super(db, "jobPosting");
  }
};
__name(JobPostingService, "JobPostingService");

// src/routes/job-posting.routes.ts
function registerJobPostingRoutes(app2) {
  createCrudRoutes(
    app2,
    "/api/job-postings",
...
__name(registerJobPostingRoutes, "registerJobPostingRoutes");

// src/services/job-role.service.ts
var JobRoleService = class extends BaseService {
  constructor(db) {
    super(db, "jobRole");
  }
};
__name(JobRoleService, "JobRoleService");

// src/routes/job-role.routes.ts
function registerJobRoleRoutes(app2) {
  createCrudRoutes(
    app2,
    "/api/job-roles",
...
__name(registerJobRoleRoutes, "registerJobRoleRoutes");

// src/services/competitor-job.service.ts
var CompetitorJobService = class extends BaseService {
  constructor(db) {
    super(db, "competitorJob");
  }
};
__name(CompetitorJobService, "CompetitorJobService");

// src/routes/competitor-job.routes.ts
function registerCompetitorJobRoutes(app2) {
  createCrudRoutes(
    app2,
    "/api/competitor-jobs",
...
__name(registerCompetitorJobRoutes, "registerCompetitorJobRoutes");

// src/services/organization.service.ts
var OrganizationService = class extends BaseService {
  constructor(db) {
    super(db, "organization");
  }
};
__name(OrganizationService, "OrganizationService");
...
__name(SelectionProcessService, "SelectionProcessService");

// src/routes/selection-process.routes.ts
function registerSelectionProcessRoutes(app2) {
  createCrudRoutes(
    app2,
...
__name(registerSelectionProcessRoutes, "registerSelectionProcessRoutes");

// src/services/recruitment-channel.service.ts
var RecruitmentChannelService = class extends BaseService {
  constructor(db) {
    super(db, "recruitmentChannel");
  }
};
__name(RecruitmentChannelService, "RecruitmentChannelService");

// src/routes/recruitment-channel.routes.ts
function registerRecruitmentChannelRoutes(app2) {
  createCrudRoutes(
    app2,
...
__name(registerRecruitmentChannelRoutes, "registerRecruitmentChannelRoutes");

// src/services/faq.service.ts
var FaqService = class extends BaseService {
  constructor(db) {
    super(db, "faq");
  }
};
__name(FaqService, "FaqService");

// src/routes/faq.routes.ts
function registerFaqRoutes(app2) {
  createCrudRoutes(
    app2,
    "/api/faqs",
...
var HistoryService = class {
  ...
  async getHistory(entityId, entityType) {
    return await getHistory(this.db, entityId, entityType);
  }
};
__name(HistoryService, "HistoryService");
...
__name(registerHistoryRoutes, "registerHistoryRoutes");

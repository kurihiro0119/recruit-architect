...
export const kpiSnapshotApi = {
  ...
  update: (id: string, data: unknown) =>
    api.put(`/api/kpi-snapshots/${id}`, data),
...
export const initiativeApi = {
  ...
  update: (id: string, data: unknown) =>
    api.put(`/api/initiatives/${id}`, data),
...
export const companyAnalysisApi = {
  ...
  update: (id: string, data: unknown) =>
    api.put(`/api/company-analyses/${id}`, data),
...
export const jobPostingApi = {
  ...
  update: (id: string, data: unknown) =>
    api.put(`/api/job-postings/${id}`, data),
...
export const competitorJobApi = {
  ...
  update: (id: string, data: unknown) =>
    api.put(`/api/competitor-jobs/${id}`, data),
...
export const organizationMemberApi = {
  ...
  update: (id: string, data: unknown) =>
    api.put(`/api/organization-members/${id}`, data),
...
export const selectionProcessApi = {
  ...
  update: (id: string, data: unknown) =>
    api.put(`/api/selection-processes/${id}`, data),
...
export const recruitmentChannelApi = {
  ...
  update: (id: string, data: unknown) =>
    api.put(`/api/recruitment-channels/${id}`, data),
...
export const faqCategoryApi = {
  ...
  update: (id: string, data: unknown) =>
    api.put(`/api/faq-categories/${id}`, data),
...
export const getAuthenticatedApi = (token: string) => ({
  kpi: {
    ...
    update: (id: string, data: unknown) =>
      userApiWithAuth(token).put(`/api/kpis/${id}`, data),
    delete: (id: string) => userApiWithAuth(token).delete(`/api/kpis/${id}`),
  },
  organization: {
    getAll: () => userApiWithAuth(token).get("/api/organizations"),
    getById: (id: string) =>
      userApiWithAuth(token).get(`/api/organizations/${id}`),
    update: (id: string, data: unknown) =>
      userApiWithAuth(token).put(`/api/organizations/${id}`, data),
  },
  // 他のAPIも同様に追加可能
});
